<?php
	...
	/**
	 * Class InvalidHookIdentifier
	 *
	 * This exception indicates that a supplied hook identifier is not of a valid format. (String is required.)
	 *
	 * @package LiftKit\Application\Exception
	 */
	class InvalidHookIdentifier extends Exception
	{
